...
class augDataset(Dataset):
    def __init__(self, x, y, x_normalise:bool=True, y_normalise:bool=False):
...
def aug_dataloader(dataset:augDataset, batch_size:int=32, train_ratio:float=0.8, val_ratio:float=0.1, shuffle:bool=True, seed:int=None):
    # Initialise
    if seed is not None:
